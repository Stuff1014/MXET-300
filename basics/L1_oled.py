...
def getVoltage():
    ...
    ##########################################
    return current_voltage # Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((0, 0), "All Hail Our", font=font, fill=255)
    draw.text((0, 10), "Robot Overlords", font=font, fill=255)
    ...
    draw.text((0, 30), "IP: " + ip, font=font, fill=255)
    ...
    #################################################
    draw.text((0, 50), str(getVoltage()) + "V", font=font, fill=255)
